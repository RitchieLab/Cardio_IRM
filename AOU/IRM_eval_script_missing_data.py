...
# export dfs
total_cvd_auroc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_total_cvd.AUROC.' + colname + '.txt'), sep = '\t')
total_cvd_auprc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_total_cvd.AUPRC.' + colname + '.txt'), sep = '\t')
total_cvd_f1_df.to_csv((output_dir + pheno + '.PREVENT_CRS_total_cvd.F1_SCORE.' + colname + '.txt'), sep = '\t')
total_cvd_balanced_acc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_total_cvd.BALANCED_ACCURACY.' + colname + '.txt'), sep = '\t')
total_cvd_beta_df.to_csv((output_dir + pheno + '.PREVENT_CRS_total_cvd.BETA.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')
total_cvd_pval_df.to_csv((output_dir + pheno + '.PREVENT_CRS_total_cvd.PVAL.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')

ascvd_auroc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_ascvd.AUROC.' + colname + '.txt'), sep = '\t')
ascvd_auprc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_ascvd.AUPRC.' + colname + '.txt'), sep = '\t')
ascvd_f1_df.to_csv((output_dir + pheno + '.PREVENT_CRS_ascvd.F1_SCORE.' + colname + '.txt'), sep = '\t')
ascvd_balanced_acc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_ascvd.BALANCED_ACCURACY.' + colname + '.txt'), sep = '\t')
ascvd_beta_df.to_csv((output_dir + pheno + '.PREVENT_CRS_ascvd.BETA.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')
ascvd_pval_df.to_csv((output_dir + pheno + '.PREVENT_CRS_ascvd.PVAL.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')

heart_failure_auroc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_heart_failure.AUROC.' + colname + '.txt'), sep = '\t')
heart_failure_auprc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_heart_failure.AUPRC.' + colname + '.txt'), sep = '\t')
heart_failure_f1_df.to_csv((output_dir + pheno + '.PREVENT_CRS_heart_failure.F1_SCORE.' + colname + '.txt'), sep = '\t')
heart_failure_balanced_acc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_heart_failure.BALANCED_ACCURACY.' + colname + '.txt'), sep = '\t')
heart_failure_beta_df.to_csv((output_dir + pheno + '.PREVENT_CRS_heart_failure.BETA.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')
heart_failure_pval_df.to_csv((output_dir + pheno + '.PREVENT_CRS_heart_failure.PVAL.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')

stroke_auroc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_stroke.AUROC.' + colname + '.txt'), sep = '\t')
stroke_auprc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_stroke.AUPRC.' + colname + '.txt'), sep = '\t')
stroke_f1_df.to_csv((output_dir + pheno + '.PREVENT_CRS_stroke.F1_SCORE.' + colname + '.txt'), sep = '\t')
stroke_balanced_acc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_stroke.BALANCED_ACCURACY.' + colname + '.txt'), sep = '\t')
stroke_beta_df.to_csv((output_dir + pheno + '.PREVENT_CRS_stroke.BETA.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')
stroke_pval_df.to_csv((output_dir + pheno + '.PREVENT_CRS_stroke.PVAL.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')

chd_auroc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_chd.AUROC.' + colname + '.txt'), sep = '\t')
chd_auprc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_chd.AUPRC.' + colname + '.txt'), sep = '\t')
chd_f1_df.to_csv((output_dir + pheno + '.PREVENT_CRS_chd.F1_SCORE.' + colname + '.txt'), sep = '\t')
chd_balanced_acc_df.to_csv((output_dir + pheno + '.PREVENT_CRS_chd.BALANCED_ACCURACY.' + colname + '.txt'), sep = '\t')
chd_beta_df.to_csv((output_dir + pheno + '.PREVENT_CRS_chd.BETA.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')
chd_pval_df.to_csv((output_dir + pheno + '.PREVENT_CRS_chd.PVAL.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')

if pheno == 'AFIB':
    c2hest_auroc_df.to_csv((output_dir + pheno + '.C2HEST_CRS.AUROC.' + colname + '.txt'), sep = '\t')
    c2hest_auprc_df.to_csv((output_dir + pheno + '.C2HEST_CRS.AUPRC.' + colname + '.txt'), sep = '\t')
    c2hest_f1_df.to_csv((output_dir + pheno + '.C2HEST_CRS.F1_SCORE.' + colname + '.txt'), sep = '\t')
    c2hest_balanced_acc_df.to_csv((output_dir + pheno + '.C2HEST_CRS.BALANCED_ACCURACY.' + colname + '.txt'), sep = '\t')
    c2hest_beta_df.to_csv((output_dir + pheno + '.C2HEST_CRS.BETA.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')
    c2hest_pval_df.to_csv((output_dir + pheno + '.C2HEST_CRS.PVAL.' + colname + '.txt'), sep = '\t', na_rep = 'NaN')