...
title = 'UKBB ' + pheno + ' Prediction Receiver-Operating Curves'
...
title = 'UKBB ' + pheno + ' Prediction Precision-Recall Curves'
...
plt.savefig(output_dir + 'UKBB.' + pheno + ".ROC_PRC_curve_combined.png", dpi = 300)